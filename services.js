...
document.addEventListener("DOMContentLoaded", function () {
  ...
  dropdowns.forEach(function (dropdown) {
    ...
    if (window.innerWidth <= 700) {
      ...
      var originalHref = dropbtn.getAttribute("href");
      ...
      dropbtn.addEventListener("click", function (e) {
        ...
        // If dropdown content is not visible, show it and prevent navigation
        if (window.getComputedStyle(dropdownContent).visibility === "hidden") {
          e.preventDefault();
